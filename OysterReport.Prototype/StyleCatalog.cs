// Flat snapshot of the workbook's style tables: fonts, fills, borders, number formats, and cell format indices.
// Each cell's s="N" index refers into CellXfs[N].
...
internal sealed class StyleCatalog
{
    ...
    {
        // Order in theme1.xml: dk1, lt1, dk2, lt2, accent1..6, hlink, folHlink.
        // Excel's style index: 0=lt1, 1=dk1, 2=lt2, 3=dk2, 4..=accent1.., 10=hlink, 11=folHlink.
        // We re-index on load so that themeColors[N] matches the style index directly.
        var defaults = new[]
        {
            Color.White,
            Color.Black,
        ...
        // The theme XML children list them in dk1, lt1, dk2, lt2 order.
