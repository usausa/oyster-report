// Resolves OpenXML color elements (theme/indexed/rgb/auto) to the "#AARRGGBB" hex format used by ReportCellStyle.
// Reuses OysterReport.Internal.ColorHelper.ApplyTint / NormalizeHex for tint calculation and normalization.
...
internal sealed class ColorResolver
{
    ...
    [
        ...
        0xFF000000, 0xFFFFFFFF // 64=system foreground, 65=system background
    ];
    ...
    public string Resolve(SsColor? color, string fallbackHex)
    {
        ...
        // Auto → treated as caller's fallback (usually black/white)
    ...
    {
        // Accept 6- or 8-char hex (with or without #). Output "#AARRGGBB" upper.
